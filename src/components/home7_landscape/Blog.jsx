        ...
        <div className="row gx-5">
          <div className="col-lg-6">
            <div
              ...
              data-wow-delay="0.2s"
            >
              <a href="/SingleProject" className="img">
                <img
              ...
              <div className="info">
                ...
                <div className="cont">
                  <a href="/SingleProject02" className="title fsz-24 hover-underline d-block">
          ...
          <div className="col-lg-6">
            <div className="sub-posts ps-lg-5 mt-5 mt-lg-0">
              ...
              >
                ...
                <div className="cont">
                  <a href="/SingleProject03" className="title fsz-24 hover-underline d-block">
              ...
              >
                ...
                <div className="cont">
                  <a href="/SingleProject04" className="title fsz-24 hover-underline d-block">
              ...
              >
                ...
                <div className="cont">
                  <a href="/SingleProject05" className="title fsz-24 hover-underline d-block">
