                  ...
                  <div className="info pt-50">
                    <div className="row">
                      ...
                      <div className="col-lg-9">
                        <div className="cont">
                          <h3 className="fsz-24">
                            <a href="/SinglePostPage" className="hover-orange1">
                              How to handle the day light in <br /> Vray for
                              best reality
                            </a>
                          </h3>
                          <div className="tags fsz-12 color-orange1 text-uppercase mt-20">
                            <a href="/SinglePostPage"> Architecture, </a>
                            <a href="/SinglePostPage"> Guide </a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-9">
                        <div className="cont">
                          ...
                          <div className="tags fsz-12 color-orange1 text-uppercase mt-20">
                            <a href="/SinglePostPage"> Inspiration, </a>
                            <a href="/SinglePostPage"> interior </a>
                          </div>
                        </div>
                      </div>
                    </div>
